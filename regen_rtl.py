...
layout = ''
device = Device(Nx, Ny, C, T, T, IO_I, IO_O, layout,
                pe_pipelining_stages, noc_pipelining_stages, 1, P, II)
...
op_addresses, op_port_select, asserts_string, latency = RTLGenerator.generate_and_write_pe_memories(
    PROJ_DIR, resource_graph, net_paths, dataflow_graph, placement, enter, exit_,
    NUM_OPERANDS, IO_I, II, device)
