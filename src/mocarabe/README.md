...
e.g. `python3 mocarabe.py -dfg hls/int_poly3 -iod 1 -ard 1 -II 1 -C 2 --place_time 0.1 --sched_method ILP`
...
## placer
Placing and partitioning is in the `placer` module.  The current flow is ILP DFG Partitioning + Annealing placement of those partitions, but placement of DFG nodes directly with annealing is also supported.
++
